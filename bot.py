...
PREFIX = "cl!"  # <-- change this to your unique prefix

# Optional: put your Hosted Lobbies role ID here if you want a ping
HOSTED_ROLE_ID = 1467862590670639249  # example: 123456789012345678
...
class CopyCodeView(discord.ui.View):
    def __init__(self, code: str):
        ...
        # "Copy text" button (shows 'Copied to clipboard' on click)
        self.add_item(
            discord.ui.Button(
                label="Copy code",
                emoji="📋",
